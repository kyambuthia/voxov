...
const std::vector<StateDef> &definitions_storage() {
    static const std::vector<StateDef> defs = {
        ...
        },
        {
            ...
            "locomotion_walk_forward_right",
            {"locomotion_walk_forward_right", "walk_forward_right", "walk_diag_fr", "walk_strafe_forward_right"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            {"locomotion_walk_right", "walk_right", "strafe_right", "walk_strafe_right"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            "locomotion_walk_backward_right",
            {"locomotion_walk_backward_right", "walk_backward_right", "walk_diag_br", "backpedal_right"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            "locomotion_walk_backward",
            {"locomotion_walk_backward", "walk_backward", "walk_back", "backpedal"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            "locomotion_walk_backward_left",
            {"locomotion_walk_backward_left", "walk_backward_left", "walk_diag_bl", "backpedal_left"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            {"locomotion_walk_left", "walk_left", "strafe_left", "walk_strafe_left"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            "locomotion_walk_forward_left",
            {"locomotion_walk_forward_left", "walk_forward_left", "walk_diag_fl", "walk_strafe_forward_left"},
            {PlayerAnimState::LocomotionWalk},
            {
                EventDef{0.14f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.62f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunForwardRight,
            "locomotion_run_forward_right",
            {"locomotion_run_forward_right", "run_forward_right", "run_diag_fr", "run_strafe_forward_right"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunRight,
            "locomotion_run_right",
            {"locomotion_run_right", "run_right", "sprint_right", "run_strafe_right"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunBackwardRight,
            "locomotion_run_backward_right",
            {"locomotion_run_backward_right", "run_backward_right", "run_diag_br", "sprint_back_right"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunBackward,
            "locomotion_run_backward",
            {"locomotion_run_backward", "run_backward", "run_back", "sprint_back"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        },
        {
            ...
            "locomotion_run_backward_left",
            {"locomotion_run_backward_left", "run_backward_left", "run_diag_bl", "sprint_back_left"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunLeft,
            "locomotion_run_left",
            {"locomotion_run_left", "run_left", "sprint_left", "run_strafe_left"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
        ...
        {
            PlayerAnimState::LocomotionRunForwardLeft,
            "locomotion_run_forward_left",
            {"locomotion_run_forward_left", "run_forward_left", "run_diag_fl", "run_strafe_forward_left"},
            {PlayerAnimState::LocomotionRun},
            {
                EventDef{0.12f, PlayerAnimEventType::Footstep, "left"},
                EventDef{0.56f, PlayerAnimEventType::Footstep, "right"},
